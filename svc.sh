...
SVC_NAME="actions.runner.AshishDuhanCoder-devpipelinetest.ip-172-31-90-156.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (AshishDuhanCoder-devpipelinetest.ip-172-31-90-156)"
